            ...
            <tr>
                ...
                <td class="cHead">
                    <?php if($result['estado'] == 1):?>
                        <a href="" class="btn btn-Warning btnHDUser" id-user="<?php echo $result['idusuario'];?>" estado="0"><i class="fas fa-user-lock"></i></a>
                    <?php else:?>
                        <a href="" class="btn btn-Warning btnHDUser" id-user="<?php echo $result['idusuario'];?>" estado="1"><i class="fas fa-user-check" ></i></a>
                    <?php endif?>    
                </td>
                <td class="cHead">
                    <a href="" class="btn btn-Info updateUser" id-user="<?php echo $result['idusuario'];?>" data-toggle="modal" ><i class="fas fa-user-edit"></i></a>
                </td>
                <td>
