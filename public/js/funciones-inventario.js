$(document).ready(function() {
    ...
    $(".btnHDProd").click(function(event){
        ...
        $("#result-form").load("inventario/cambiar_estado.php?id_producto="+id+"&estado="+estado);
        event.preventDefault();
    });
    ...
    $(".updateProd").click(function(){
        ...
        $('#ProdUpd').modal('show');
        $("#dataProd").load("inventario/updateDataUser.php?id_producto="+id);
    });
    ...
    $("#UpdProd").on("submit",function(event)
    {
        ...
        formData.append("dato","valor");
         ...
         $.ajax({
            url:"inventario/update_prod.php",
            type: "POST",
            dataType: "html",
            data: formData,
            cache: false,
    ...
    $(".BtnDrop-prod").click(function(event) {
        var id;
        id = $(this).attr("id-prod");
        $("#result-form").load("inventario/delete_prod.php?id_producto="+id);
        event.preventDefault();
    });
